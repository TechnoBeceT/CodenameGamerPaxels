...
public class AmethystImbuementItems {
    public static final Item GARNET_PAXEL = registerItem("garnet_paxel", new PaxelItem(CompatToolMaterials.GARNET, 6.0f, -2.8f, new FabricItemSettings()));
    public static final Item GLOWING_PAXEL = registerItem("glowing_paxel", new PaxelItem(CompatToolMaterials.GLOWING, 6.0f, -2.8f, new FabricItemSettings()));
    public static final Item AI_STEEL_PAXEL = registerItem("ai_steel_paxel", new PaxelItem(CompatToolMaterials.STEEL, 6.0f, -2.8f, new FabricItemSettings()));
    public static final Item AMETRINE_PAXEL = registerItem("ametrine_paxel", new PaxelItem(CompatToolMaterials.AMETRINE, 6.0f, -2.8f, new FabricItemSettings()));
